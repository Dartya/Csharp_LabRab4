...
ЗАДАНИЕ 2.
Используя класс StringBuilder сформировать текст, состоящий из 100 строк.Каждая строка длиной от 20 до 100 случайных символов. 
Записать полученный результат в переменную типа string, вывести результат в консоль.
*/
